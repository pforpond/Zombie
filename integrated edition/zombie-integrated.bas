...
CLS
LOCATE 12, 40 - (14 / 2): COLOR 12: PRINT "ROM OK!"
_DELAY 3
CLS
RETURN
...
END IF
REM PAUSE MENU
IF UCASE$(a$) = "Q" THEN GOSUB pausemenu
...
IF dmenu = 2 THEN
    ...
    DO
        ...
        IF UCASE$(m$) = "Q" THEN LET dmenu = 1: LET dmenua = 14: GOTO menuloop1
        IF dmenua < 14 THEN LET dmenua = 14
        IF dmenua > 18 THEN LET dmenua = 18
    LOOP UNTIL m$ = " "
    IF dmenua = 14 THEN
...
IF dmenu = 5 THEN
    ...
    DO
        ...
        IF m$ = CHR$(0) + CHR$(72) THEN LOCATE dmenua, 40: PRINT "   ": LET dmenua = dmenua - 1
        IF m$ = CHR$(0) + CHR$(80) THEN LOCATE dmenua, 40: PRINT "   ": LET dmenua = dmenua + 1
        IF UCASE$(m$) = "Q" THEN LET dmenu = 1: LET dmenua = 14: GOTO menuloop2
        IF dmenua < 14 THEN LET dmenua = 14
        IF dmenua > 18 THEN LET dmenua = 18
    LOOP UNTIL m$ = " "
    IF dmenua = 14 THEN
...
LET messagec = 32
GOSUB message
LET message$ = "Press Q to go back!"
LET messagec = 21
GOSUB message
